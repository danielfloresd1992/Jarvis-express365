...
function DivAttention({ awaitWindow, boxModal, reset: reset2, title, data }) {
  ...
  reactExports.useEffect(() => {
    if (establishment.name === "Mister Aventura" || establishment.name === "Mister Brickell P." || establishment.name === "Mister Coconut" || establishment.name === "Mister Wynwood" || establishment.name === "Mister PineCrest") {
  ...
  const sendImg = async (e2) => {
    try {
      ...
      let text;
      const data2 = useDataUser(user, establishment);
    ...
    FormLayaut,
    {
      ...
      children: [
        ...
        hasFinishedState ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          ...
          establishment.franchise === "Mister01" ? /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "box-textHourResult", children: [
            "Tiempo excedido: ",
...
function Main({ value, selectNovelty, awaitWindow, boxModal, menu }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "main-content", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { id: "table-data", className: "w-full flex-1 min-h-0 overflow-auto rounded-xl border border-[#0a3a66]/60 bg-[#01122c]", children: [
    ...
    typeDelay.type === "1raAttention" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed right-0 w-[50%] z-[900] top-[calc(var(--titlebar-h)+50px)] h-[calc(100%-var(--titlebar-h)-50px)]", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      DivAttention,
      {
